...
class Smarty extends Smarty_Internal_Data {
	...
	*/
    ...
    { 
        ...
        $this->template_dir = array('/usr/local/apache/htdocs/ibm_cinema/view/templates/');
        $this->compile_dir = '.' . DS . 'templates_c' . DS;
        $this->compile_dir = '/usr/local/apache/htdocs/ibm_cinema/view/templates_c/';
        $this->plugins_dir = array(SMARTY_PLUGINS_DIR);
        $this->cache_dir = '.' . DS . 'cache' . DS;
        $this->cache_dir = '/usr/local/apache/htdocs/ibm_cinema/view/cache/';

...
{ 
    ...
    public function search($q,$startTime,$endTime,$count=100)
    {
    	return $this->oauth->get( 'http://api.t.sina.com.cn/statuses/search.json',array('q'=>$q,'starttime'=>$startTime,'endtime'=>$endTime,'count'=>$count) );
	}
